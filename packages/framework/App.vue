<template lang="pug">
palette(seed="abcdefghi" :offset="paletteOffset")
  .app.w-screen.h-screen.overflow-hidden(:class="{ loaded }")
    .content.absolute.w-full.h-full(class="z-[5]")
      router-view(v-slot="{ Component }")
        transition(name="fade")
          component(:is="Component")
    background.absolute.top-0.left-0.w-full.h-full.z-0(:blob-amount="2")
</template>
...
.app.loaded
  transition: 1s
  transition-property: --theme-color0-lighter, --theme-color0, --theme-color0-darker
